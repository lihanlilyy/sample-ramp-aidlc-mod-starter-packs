...
**Options:**
1. [Option 1 — AI Recommended]: [Description with rationale]
...
- Mark one option as "AI Recommended" with rationale
...
- If the user does not respond, ask whether to use AI recommendations as defaults
...
### Activation
**MANDATORY**: Load and follow the `reverse-engineering.md` instruction file.
...
to execute as a single request.
...
After `tasks.md` is approved, the user picks tasks to execute. For each task:
